...
export const LIVES: Record<string, LifeStory> = {
  ...
  "gipsy-kings": {
    ...
    original: [
      ...
      "Historia, mai 2026. Cooking Vinyl. NPR Alt.Latino, 20 mai 2026.",
    ],
    en: [
      ...
      "Historia, May 2026. Cooking Vinyl. NPR Alt.Latino, 20 May 2026.",
    ],
    sources: [
      { label: "gipsykings.com", href: "https://www.gipsykings.com/" },
      { label: "NPR Alt.Latino, 20 May 2026", href: "https://www.npr.org/2026/05/20/nx-s1-5826992/gipsy-kings-are-back-julieta-venegas-nortena-roots-and-more" },
  ...
  "fanfare-ciocarlia": {
    ...
    original: [
      ...
      "The Devil Rides Again, 2025. Asphalt Tango. Cu Adrian Raso.",
    ...
    en: [
      ...
      "The Devil Rides Again, 2025. Asphalt Tango. With Adrian Raso.",
    ...
    sources: [
      ...
      { label: "Asphalt Tango — The Devil Rides Again", href: "https://www.asphalt-tango.de/shop/the-devil-rides-again" },
  ...
  "boross-lajos": {
    ...
    original: [
      ...
      "Hankó-szalag (Limberger, feltöltés 2020) — magánfelvétel, holland turné, 1960-as évek; Hankó Ferenc brács + Boross hegedű; hátat fordítva, vita a vonókar miatt.",
    ],
    en: [
    ...
    sources: [
      ...
      { label: "Tcha Limberger — Hanko Ferenc and Boros Lajos, 9 December 2020", href: "https://youtu.be/8Mw2Ay4FBSE" },
    ],
  },
  "jaroka-sandor-sr": {
    lang: "hu",
